        ...
        <section class="py-20 bg-gray-900">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <p class="text-sm font-semibold text-gray-400 mb-4 tracking-wide uppercase">HOW IT WORKS</p>
                    <h2 class="text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
                        AdMesh Connects Your Brand to AI Platforms
                    </h2>
                ...
                <div class="grid md:grid-cols-3 gap-8 mb-16">
                    ...
                    <div class="bg-gray-800 rounded-2xl p-8 text-center border border-gray-700 relative">
                        <!-- Step Number -->
                        <div class="absolute top-6 right-6 text-6xl font-bold text-gray-700 opacity-50">1</div>
                        ...
                        <h3 class="text-2xl font-bold text-white mb-4">Publish Your Offers</h3>
                        <p class="text-gray-300 leading-relaxed">
                            Upload your products to the AdMesh network with structured metadata that 
                    ...
                    <div class="bg-gray-800 rounded-2xl p-8 text-center border border-gray-700 relative">
                        <!-- Step Number -->
                        <div class="absolute top-6 right-6 text-6xl font-bold text-gray-700 opacity-50">2</div>
                        ...
                        <h3 class="text-2xl font-bold text-white mb-4">Get Matched by AI Platforms</h3>
                        <p class="text-gray-300 leading-relaxed">
                            AI platforms dynamically pull your offers based on real-time user queries and 
                            preferences.
                        </p>
                    </div>
                    ...
                    <div class="bg-gray-800 rounded-2xl p-8 text-center border border-gray-700 relative">
                        <!-- Step Number -->
                        <div class="absolute top-6 right-6 text-6xl font-bold text-gray-700 opacity-50">3</div>
                        ...
                        <h3 class="text-2xl font-bold text-white mb-4">Pay Only for Results</h3>
                        <p class="text-gray-300 leading-relaxed">
                ...
                <!-- Call-to-Action -->
                <div class="text-center">
                    <button onclick="startCampaign()" class="bg-white text-gray-900 px-8 py-3 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-all shadow-lg">
                        Get Started
                    </button>
                </div>
            </div>
